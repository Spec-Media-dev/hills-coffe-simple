...
export function CatalogCard({
  ...
  return (
    <HoverLift className="h-full">
      <article className="group flex h-full flex-col overflow-hidden border border-border bg-card transition-colors duration-300 hover:border-highlight">
        ...
        <div className="flex flex-1 flex-col p-6">
          ...
          <div className="mt-auto flex items-end justify-between gap-4 pt-8">
            ...
            <Link
              ...
              className="min-h-11 bg-primary px-5 py-3 text-xs font-bold text-primary-foreground"
            >
              {labels.view}
            </Link>
          </div>
